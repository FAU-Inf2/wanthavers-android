...
public class DesireDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDesireDetailPresenter = new DesireDetailPresenter(this, desireLogic, UseCaseHandler.getInstance(),
                ...
                new UnacceptHaver(haverRepository), new UpdateRequestedPrice(haverRepository), new SetDesire(desireRepository));
